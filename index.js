...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@sndrzqy_')
...
if (text == 'Ruka')
{
conn.sendMessage(id, tambahan.Ruka ,MessageType.Iya?);
}
else if (text == 'hai')
{
